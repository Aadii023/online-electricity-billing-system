...
<body style="background-color:rgba(0,0,0,0.5);">
    ...
    <!-- Fixed navbar -->
    <div class="navbar navbar-default navbar-fixed-top " style="background-color: #000000;">
        <div class="container">
    ...
    <div id="headerwrap" style="background-color: rgba(255,255,255,0);">
    ...
    <div class="container">
        ...
        <div class="row mt centered">
            <div class="col-lg-4">
                <img src="assets/img/ser001.png" width="180" alt="">
                <h4 >1 - Login</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                <img src="assets/img/ser002.jpg" height="180" alt="">
